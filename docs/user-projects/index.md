...
<a href="../basics/sdcard.md" class="project-card card-motiontracker">
  <div class="image">📊</div>
...
<a href="../advanced/ble.md" class="project-card card-rgbmood">
  <div class="image">🌈</div>
...
<a href="../advanced/I2S.md" class="project-card card-musical inactive">
  <div class="image">🎵</div>
...
<a href="../basics/gpio.md" class="project-card card-robotcar inactive">
  <div class="image">🤖</div>
...
<a href="../basics/gpio.md" class="project-card card-gamecontroller inactive">
  <div class="image">🎮</div>
...
<a href="../advanced/ai.md" class="project-card card-plantmonitor inactive">
  <div class="image">🧠</div>
...
<a href="../advanced/ble.md" class="project-card card-smarthome inactive">
  <div class="image">🏠</div>
...
<a href="../advanced/esp-now.md" class="project-card card-meshnetsensor inactive">
  <div class="image">🔗</div>
...
<a href="../advanced/wif.md" class="project-card card-weatherstation inactive">
  <div class="image">🌐</div>
