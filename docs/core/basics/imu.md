...
In this tutorial, we will walk through how to use the built-in IMU on the tinyCore, using the Arduino IDE. At this point, you should have **already installed the custom board library** and tested flashing code with an example program (e.g. Blink).
