# How to detect motion using the IMU
...
Now that you know where it is, let's walk through how to use it with the Arduino IDE. At this point, you should have [**already installed the custom board library**](../../1_get-started/arduino-ide.md) and tested flashing code with an example program (e.g. Blink).
